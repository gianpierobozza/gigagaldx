...
public class Assets implements Disposable, AssetErrorListener {
    ...
    public class GigaGalAssets {
        ...
        public GigaGalAssets(TextureAtlas atlas) {
            ...
            walkingLeftAnimation = new Animation(Constants.GIGAGAL_WALK_LOOP_DURATION, walkingLeftFrames, PlayMode.LOOP);
            ...
            walkingRightAnimation = new Animation(Constants.GIGAGAL_WALK_LOOP_DURATION, walkingRightFrames, PlayMode.LOOP);
        }
    }
